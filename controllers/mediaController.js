...
module.exports.createMedia = async (req, res) => {
    // Cria um novo documento de mídia com os dados enviados no corpo da requisição
    const newMedia = new media(req.body); // 'media' é o seu Model importado no topo do arquivo

    // Salva o novo documento no banco de dados
    await newMedia.save();

    // Responde com o status 201 (Created) e os dados do item que foi criado
